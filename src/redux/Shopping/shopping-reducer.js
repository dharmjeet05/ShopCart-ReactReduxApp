  ...
  products: [
    {
      ...
      description:
        "This cube will keep you busy the entire day and it is very fun to play with some great advise from famous people",
      price: 15.0,
      image:
    ...
    },
    {
      ...
      description:
        "Get a big cup of coffee every morning before the day starts some great advise from famous people",
      price: 20.0,
      image:
...
const shopReducer = (state = INITIAT_STATE, action) => {
  switch (action.type) {
    case actionTypes.ADD_TO_CART:
      //get the item data from the prducts array
